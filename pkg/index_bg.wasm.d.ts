...
export function __wbg_comrademajor_free(a: number): void;
export function comrademajor_new(): number;
export function comrademajor_processFile(a: number, b: number, c: number): void;
...
export function message_url(a: number, b: number): void;
...
export function post_id(a: number, b: number): void;

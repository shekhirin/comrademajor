...
* @returns {string}
*/
export function highlightKindToString(kind) {
    try {
        const retptr = wasm.__wbindgen_export_2.value - 16;
        wasm.__wbindgen_export_2.value = retptr;
        wasm.highlightKindToString(retptr, kind);
...
export class Post {
    ...
    */
    get author() {
        try {
            const retptr = wasm.__wbindgen_export_2.value - 16;
            wasm.__wbindgen_export_2.value = retptr;
            wasm.post_author(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            let v0;
            if (r0 !== 0) {
    ...
    */
    get text() {
        try {
            const retptr = wasm.__wbindgen_export_2.value - 16;
            wasm.__wbindgen_export_2.value = retptr;
            wasm.post_text(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            let v0;
            if (r0 !== 0) {
    ...
    */
    get kludges() {
        var ret = wasm.post_kludges(this.ptr);
        return takeObject(ret);
    }
    /**
    ...
    */
    get highlightedParts() {
        var ret = wasm.post_highlightedParts(this.ptr);
        return takeObject(ret);
    }
    /**
